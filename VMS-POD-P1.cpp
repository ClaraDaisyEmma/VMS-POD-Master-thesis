...
#include "save-csv.h" 
#include "example-problem-P1.h"
#include "FE-P1-matrices.h"
...
int main(){
    ...
    constexpr int M=500, N=500, r=40, R=20;                                                        
    int nodes=M-1;                                                                               
    ...
    //The hadder file FE-P1-matrices.h includes the functions B_0(int dim) and B_2(int dim), which provides (nodex x nodes)-matrices.
    B0=B_0(nodes);
    B2=B_2(nodes);
    //The hadder file example-problem-P1.h includes the functions Snapshots(int numbNotes, int timesteps) and 
    ...
    const std::string dataName_results = "VMS-POD-P1-results.csv";
